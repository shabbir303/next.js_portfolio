...
// import pdf from "../assests/web_developer.pdf"
      ...
      <div className="container mx-auto h-full">
        <div className="flex flex-col-reverse xl:flex-row justify-between items-center xl:pt-8 pb-24 ">
          <div className="text-center xl:text-left xl:w-[800px] py-3">
            <h1 className="h3">Web Developer</h1>
            <h1 className="h1">Hello I&apos;m <br /><span className="h1 text-accent" >Shabbir Hossain Shovo</span></h1>
            <h1>I&apos;m a passionate web developer with expertise in creating efficient and innovative solutions. I have a strong background in web development and enjoy tackling complex problems with creative and effective strategies. My goal is to deliver high-quality software that meets user needs and exceeds expectations.</h1>
            <div className="flex flex-col xl:flex-row gap-8 items-center">
              <a
               download
              href="./web_developer.pdf">
